...
module.exports.registration = async(req, res) => {
    if (config.allowRegistration) {
        ...
        try {
            ...
            mailer.send(req.body.nemail, 'Created New Account in 2021 Reunion Web App', 'newAccount', context)
        } catch (e) {
            console.log(e)
        }
        res.redirect('/cp')
...
module.exports.reset = async(req, res) => {
    ...
    if (candidate) {
        ...
        await User.findByIdAndUpdate({ "_id": candidateId }, { 'password': randPassword }, function(err, result) {
            ...
            mailer.send(candidate.email, 'New password for account in 2021 Reunion Web App', 'resetAccount', context)
